...
serve(async (req) => {
  ...
  try {
    ...
    // eBay's OAuth redirect_uri must be the RuName registered in the eBay Developer
    // Portal (Application Keys → User Tokens), not a literal callback URL like every
    // other platform here — passing a real URL gets a generic "invalid_request" 400.
