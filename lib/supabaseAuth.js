...
export const supabaseAuthService = {
  ...
  /**
   * Get current user
   * Uses getSession() instead of getUser() to avoid AuthSessionMissingError
   * race conditions during page load / post-OAuth redirect, where the Supabase
   * client may not yet have loaded the session into memory.
   */
  async me() {
