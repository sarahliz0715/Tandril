...
function createSupabaseEntity(tableName) {
  return {
    ...
    async create(values) {
      ...
      const payload = user ? { user_id: user.id, ...values } : values;
      const { data, error } = await supabase
        .from(tableName)
        .insert(payload)
        .select()
...
export const supabaseMarketIntelligence = createSupabaseEntity('market_intelligence');
export const supabaseAdCampaign = createSupabaseEntity('ad_campaigns');
export const supabaseAdCreative = createSupabaseEntity('ad_creatives');
export const supabaseAdTemplate = createSupabaseEntity('ad_templates');
...
export const createSupabaseEntities = () => {
  ...
  return {
    ...
    AdCampaign: supabaseAdCampaign,
    AdCreative: supabaseAdCreative,
    AdTemplate: supabaseAdTemplate,
    ...
    MarketIntelligence: supabaseMarketIntelligence,
    ...
    SmartAlert: createSupabaseEntity('smart_alerts'),
    ...
    OrderItem: createSupabaseEntity('order_items'),
    Order: createSupabaseEntity('orders'),
    ...
    CustomAlert: createSupabaseEntity('custom_alerts'),
  };
};
