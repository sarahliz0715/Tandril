...
const mockFunctions = {
  async chatWithCoach({ message, conversation_history = [], uploaded_files = [] } = {}) {
    console.log('🎭 [Mock Functions] AI Coach Chat:', message);

    return {
      success: true,
      response: `👋 Hi! I'm your AI Business Coach running in **demo mode**.

Since you haven't connected a real store yet, I can provide general e-commerce advice and answer strategic questions.

**What I can help with:**
- General e-commerce best practices
- Growth strategies and pricing advice
- Analyzing uploaded files (images, PDFs, CSVs)
- Strategic business questions

**To get personalized insights:**
Connect a real platform (Shopify, WooCommerce, BigCommerce, Faire, or eBay) and I'll analyze your actual store data to provide specific recommendations.
...
What would you like to know?`,
      ...
      case 'send-beta-invite':
        return {
          data: {
            success: true,
            invite_url: `${window.location.origin}?invited=true`,
            message: 'Invitation simulated in standalone mode'
          }
        };
