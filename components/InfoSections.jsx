  ...
  return (
    <div className="space-y-20 px-6 md:px-24 py-16 bg-gray-50 text-gray-800">
      ...
      <section id="what-is-tandril" className="space-y-6">
        <h2 className="text-4xl font-extrabold text-emerald-600">What is Tandril?</h2>
        ...
        <p className="text-gray-700">
          Tandril acts as an <span className="font-semibold text-emerald-600">AI operations layer</span> that unifies your data, highlights what needs attention, and helps execute improvements — all from one place.
        </p>
        <p className="text-gray-700">
        ...
        <p className="text-gray-700">
          Tandril is offered as a <span className="font-semibold text-emerald-600">monthly subscription</span> and is designed for solo sellers, growing brands, and multi-store operators.
        </p>
      </section>

      {/* Pricing */}
      <section id="pricing" className="space-y-6">
        <h2 className="text-4xl font-extrabold text-emerald-600">Pricing</h2>
      ...
      <section id="terms" className="space-y-4">
        <h2 className="text-4xl font-extrabold text-emerald-600">Terms of Service</h2>
        ...
        <p className="text-gray-700">Contact: <a href="mailto:support@tandril.ai" className="text-emerald-600 underline">support@tandril.ai</a></p>
      </section>

      {/* Privacy Policy */}
      <section id="privacy" className="space-y-4">
        <h2 className="text-4xl font-extrabold text-emerald-600">Privacy Policy</h2>
        <p className="text-gray-700">Effective Date: December 20, 2025</p>
        <ul className="list-disc list-inside space-y-2 text-gray-700">
