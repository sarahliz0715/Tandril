        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 mb-6 flex items-center justify-between"
                >
                    ...
                    <Button variant="ghost" size="icon" className="h-7 w-7 text-emerald-600 hover:bg-emerald-100" onClick={handleDismiss}>
                        <X className="w-4 h-4" />
                    </Button>
                </motion.div>
            )}
