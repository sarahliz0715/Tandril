          ...
          <CardContent className="prose max-w-none space-y-6">
            ...
            <section className="border-t pt-6">
              ...
              <p className="text-slate-700 mt-3">
                To exercise these rights, email us at <a href="mailto:hello@tandril.org" className="text-indigo-600 hover:underline font-semibold">hello@tandril.org</a>. We will respond within 30 days.
              </p>
            </section>
            ...
            <section className="border-t pt-6">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 space-y-2">
                ...
                <p className="text-slate-700">Email: <a href="mailto:hello@tandril.org" className="text-indigo-600 hover:underline font-semibold">hello@tandril.org</a></p>
