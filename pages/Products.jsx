...
export default function Products() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const LIVE_FETCH_PLATFORMS = new Set([
        'shopify', 'ebay', 'tiktok_shop', 'amazon', 'woocommerce', 'bigcommerce', 'instagram', 'walmart',
        'ecwid', 'magento', 'prestashop', 'wish', 'etsy', 'faire', 'square', 'wix', 'squarespace',
      ]);
